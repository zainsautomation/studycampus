  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "fixed z-50 grid w-full gap-4 border-0 bg-background p-5 shadow-xl",
        "max-h-[85vh] overflow-y-auto",
        // Mobile positioning
        "bottom-0 left-0 right-0 rounded-t-2xl",
        "sm:bottom-auto sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%]",
        "sm:max-w-lg sm:rounded-2xl sm:border sm:border-border/50",
        // Animations
    ...
    >
      {/* Mobile drag handle */}
      <div className="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-muted-foreground/20 sm:hidden" />
      {children}
